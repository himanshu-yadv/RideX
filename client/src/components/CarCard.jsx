  ...
  return (
    <div onClick={() => { navigate(`/car-details/${car._id}`); scrollTo(0, 0) }} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
      ...
      <div className='relative h-48 overflow-hidden'>
        ...
        {car.isAvaliable && (
          <p className='absolute top-4 left-4 bg-black text-white text-xs px-2.5 py-1 rounded-full'>
            Available Now
          </p>
        )}
      ...
      <div className='p-4 sm:p-5'>
        <div className='flex justify-between items-start mb-2'>
          <div>
            <h3 className='text-lg font-medium text-black'>{car.brand} {car.model}</h3>
