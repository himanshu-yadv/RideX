    ...
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
          <h1 className='text-lg font-medium text-black'>Recent Bookings</h1>
          ...
          {data.recentBookings.map((booking, index) => (
            <div key={index} className='mt-4 flex items-center justify-between'>
              ...
              <div className='flex items-center gap-2 font-medium'>
                ...
                <p className='px-3 py-0.5 border border-borderColor rounded-full text-sm text-black'>{booking.status}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          <h1 className='text-lg font-medium text-black'>Monthly Revenue</h1>
